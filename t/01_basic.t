...
is $calc->subtotal(), 9779, "subtotal";                             # 5

$calc->price(1000000);
is $calc->withholding(), 102100, "withholding with 1,000,000";      # 6
is $calc->subtotal(), 977900, "subtotal with 1,000,000";            # 7

$calc->price(2000000);
is $calc->withholding(), 306300, "withholding with 2,000,000";      # 8
is $calc->subtotal(), 1853700, "subtotal with 2,000,000";           # 9

$calc->price(3000000);
is $calc->withholding(), 510500, "withholding with 3,000,000";      #10
is $calc->subtotal(), 2729500, "subtotal with 3,000,000";           #11
...
is $calc->subtotal(), 1075211, "subtotal with 1,111,111";           #15
done_testing;
